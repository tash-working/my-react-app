...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-fuchsia-700 to-purple-900 text-white py-10 shadow-2xl">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-10 pt-6 border-t border-white/10 text-center">
          ...
          <p className="text-xs text-white/50 mt-2">
            Crafted with ❤️ by <a href="#" className="text-indigo-300 hover:text-white">Midenus</a>
          </p>
        </div>
      </div>
    </footer>
